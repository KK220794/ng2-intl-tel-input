import { phoneNumberValidator } from './ng2-intl-tel-input.validators';
import { Component, OnInit, forwardRef, Input } from '@angular/core';
import { CountryCode } from './data/country-code';
import { ControlValueAccessor, NG_VALIDATORS, NG_VALUE_ACCESSOR, FormControl, FormGroup, Validators, FormBuilder } from '@angular/forms';
import { Country } from './model/country.model';
import * as lpn from 'google-libphonenumber';
@Component({
  selector: 'lib-ng2-intl-tel-input',
  templateUrl: './ng2-intl-tel-input.component.html',
  styles: ['./ng2-intl-tel-input.component.scss'],
  providers: [
    CountryCode,
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => Ng2IntlTelInputComponent),
      multi: true
    },
    {
...
export class Ng2IntlTelInputComponent implements OnInit {
  @Input() value = '';
  ...
  constructor(
    private countryCodeData: CountryCode, private _formBuilder: FormBuilder
  ) {
  ...
  ngOnInit() {
    ...
    this.form2 = new FormGroup({
      phoneNo: new FormControl(this.phoneNumber)
    });
  ...
  public onPhoneNumberChange(): void {
    if (!this.bootstrap) {
      this.phoneNumber = this.form2.value['phoneNo'];
    }
  ...
  public onInputKeyPress(event: { charCode: number; preventDefault: () => void; }): void {
